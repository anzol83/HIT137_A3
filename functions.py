...
class Functions: # This class controls user actions and connects them to image processing and display.
    ...
    def brightness(self, value):
        if self.processor.image is None:
            return
        self.processor.brightness_value = int(value)# Set brightness level
    ...
    def undo(self):
        ...
        self.processor.original = self.processor.image.copy() # Reapply all effects to the undone image
        self.display(self.processor.image) # Display the undone image
